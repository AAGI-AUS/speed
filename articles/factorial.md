...
```
    ...
    ##   ..$ treatment  : chr [1:72] "A7-B1" "A8-B2" "A6-B3" "A6-B2" ...
    ...
    ##     factorial_separator = "-", ...)
    ##   .. .. .. ..- attr(*, "srcref")= 'srcref' int [1:8] 109 33 159 1 33 1 109 159
